...
import com.example.applistatelefonica.databinding.ActivityNewContactBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.buttonSave.setOnClickListener {
            ...
            if (name.isNotEmpty() && address.isNotEmpty() && email.isNotEmpty()) {
                ...
                if (res > 0) {
                    Toast.makeText(applicationContext, "Insert Contact OK", Toast.LENGTH_SHORT)
                        .show()
                    setResult(1, i)
                    finish()
                } else {
                    Toast.makeText(applicationContext, "Error Insert Contact", Toast.LENGTH_SHORT)
                        .show()
                }
            }
        }
